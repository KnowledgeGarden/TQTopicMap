...
SubjectProxy.prototype.getObject = function() {
  this.properties[properties.TUPLE_OBJECT_PROPERTY];
};
...
SubjectProxy.prototype.getObjectType = function() {
  this.properties[properties.TUPLE_OBJECT_TYPE_PROPERTY];
};

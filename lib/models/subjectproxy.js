...
var result = [];
var relns = this.properties.relations;
if (!relns)
...
var lx = this.properties.children;
...
SubjectProxy.prototype.setResourceUrl = function(url) {
  this.properties[properties.URL] = url;
};
SubjectProxy.prototype.getResourceUrl = function() {
  return this.properties[properties.URL];
};
...
SubjectProxy.prototype.setDate = function(date) {
  ...
  this.properties[properties.SORT_DATE] = date;
};
SubjectProxy.prototype.getDate = function() {
  //@see https://github.com/litejs/date-format-lite
  return this.properties[properties.CREATED_DATE].date();	
};
...
SubjectProxy.prototype.getLastEditDate = function() {
  return this.properties[properties.LAST_EDIT_DATE].Date();	
};

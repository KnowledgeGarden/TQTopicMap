...
SubjectProxy.prototype.addPivot = function(relationType, relationLabel,
		documentSmallIcon,targetLocator, targetLabel, nodeType) {
...
* @param targetLocator
* @param targetLabel
* @param transcludeUser (optional--set if is transcluded)
*/
SubjectProxy.prototype.addRelation = function(relationType, relationLabel,
	documentSmallIcon,targetLocator, targetLabel, transcludeUser) {

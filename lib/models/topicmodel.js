...
//      tuple.setSignature(signature);
      ...
      targetNode.addRelation(relationTypeLocator,relationTypeLocator,sourceNode.getSmallImage(),
				sourceNode.getLocator(),label, tu);
...
//    tuple.setSignature(signature);
    ...
    sourceNode.addPivot(relationTypeLocator,relationTypeLocator,targetNode.getSmallImage(),
				targetNode.getLocator(),label, targetNode.getNodeType());
    label = sourceNode.getLabel(language);
    if (!label) {
  	  label = sourceNode.getSubject(language);
  	  if (label) {label = label.theText;}
    ...
    targetNode.addPivot(relationTypeLocator,relationTypeLocator,sourceNode.getSmallImage(),
				sourceNode.getLocator(),label, sourceNode.getNodeType());

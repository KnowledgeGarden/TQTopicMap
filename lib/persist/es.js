...
ESClient.prototype.getDocument = function(locator, callback) {
	var q = this._jopts;
	q._id = locator;
	this.client.get(q, function(err,data) {
		console.log("ESClient.getDocument "+err+" "+data);
		callback(err,data);
	});
};
...
ESClient.prototype.existsDocument = function(locator,callback) {
	var q = this._jopts;
	q._id = locator;
	this.client.exists(q, function(err,data) {
...
ESClient.prototype.search = function(/*jopts,*/query,callback) {
	this.client.search(this._jopts, query,callback);
};

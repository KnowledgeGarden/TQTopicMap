...
module.exports.NOTE						= '/images/ibis/note.png';
module.exports.NOTE_SM					= '/images/ibis/note_sm.png';
module.exports.CHALLENGE				= '/images/ibis/challenge.png';
module.exports.CHALLENGE_SM				= '/images/ibis/challenge_sm.png';
module.exports.COLLABORATION			= '/images/collaboration.png';
module.exports.COLLABORATION_SM			= '/images/collaboration_sm.png';
module.exports.WARNING					= '/images/warning.png';
module.exports.WARNING_SM				= '/images/warning_sm.png';
...
module.exports.BIOGRAPHY				= '/images/biography.png';
module.exports.BIOGRAPHY_SM				= '/images/biography_sm.png';
...
module.exports.QUEST					= '/images/quest.gif';
module.exports.QUEST_SM					= '/images/quest_sm.gif';

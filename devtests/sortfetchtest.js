...
new index(function(err,data) {
  ...
  //first, prove there are docs
  dataProvider.listInstanceNodes(type1,0,5,credentials,function(err,data) {
	  console.log("SORTTEST INSTANCES "+err+" "+data);
	  var query = qDSL.sortedDateTermQuery("inOf",type1, 0,10);
	  //go looking
